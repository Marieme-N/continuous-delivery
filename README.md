...
- And add a `name` to recognize your running container: `--name arlaide`
...
In other words, we want you to implement continuous delivery for ARLAIDE.
...
```yaml
  ...
  script: |
    # ...
    # If arlaide is your container name
